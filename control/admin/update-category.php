    ...
    <div class="wrapper">
        ...
        if(isset($_GET['id'])){
            ...
            if($count==1){
                ...
                $_SESSION['not-category-found']="<div style='color:red'>Categoy Not Founded.</div>";
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($current_image!=""){
                            ?>
                            <img src="<?php echo SITURAL;?>images/category/<?php echo $current_image;?>" width="150px">
                            <?php
                        }
                        else{
        ...
        if(isset($_POST['submit'])){
            ...
            if(isset($_FILES['image_name']['name'])){
                ...
                if($image_name!=""){
                    ...
                    $destenation_path="../images/category/".$image_name;
                    $upload=move_uploaded_file($source_path,$destenation_path);
                    if($upload==false){
            ...
            if($res2==true){
                $_SESSION['update']="<div style='color:green'>Category Update Successfully.</div>";
                header('location:'.SITURAL.'admin/manage-category.php');
            }
            else{
