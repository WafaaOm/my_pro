...
?>
    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITURAL;?>food-search.php" method="POST">
        ...
        <div class="container">
            ...
            if($count>0){
                while($row=mysqli_fetch_assoc($res)){
                    ...
                    ?>
                        <a href="<?php echo SITURAL;?>category-foods.php?category_id=<?php echo $id;?>">
           ...
           $count2=mysqli_num_rows($res2);
            if($count2>0){
                ...
                <div class="food-menu-desc">
                    ...
                    <a href="<?php echo SITURAL;?>order.php?food_id=<?php echo $id;?>" class="btn btn-primary">Order Now</a>
                </div>
            </div>
                    <?php
